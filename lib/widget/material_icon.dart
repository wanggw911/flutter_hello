...
class MaterialIconsShowPage extends StatefulWidget {
  MaterialIconsShowPage({Key key}) : super(key: key);

  _MaterialIconsShowPageState createState() => _MaterialIconsShowPageState();
}

class _MaterialIconsShowPageState extends State<MaterialIconsShowPage> {
  @override
    ...
    return Container(
      child: GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisCount: 4,      // 每行列数：3列
            childAspectRatio: 5/4,  // 宽高比：3/3就是宽高相等
        ),
        itemCount: materialIconsList.length,
  ...
  Widget _gridViewItem(int index) {
    Map map = materialIconsList[index];
    return Container(
...
List<Map<String, IconData>> materialIconsList = [
